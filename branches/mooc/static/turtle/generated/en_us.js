  ...
  if (opt_ijData.page == 2) {
    switch (opt_ijData.level) {
      case 6:
        ...
        break;
      case 7:
        output += 'To make me move different distances, use the "counter" block with the "move forward" block.';
        break;
      case 9:
