...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  output += '</h1></td><td class="farSide"><select id="languageMenu" onchange="BlocklyApps.changeLanguage();"></select> &nbsp; <button id="pegmanButton" onmousedown="Maze.showPegmanMenu();"><img src="../media/1x1.gif"><span>&#x25BE;</span></button></td></tr></table><div id="levelFeedback"><div style="padding-bottom: 0.7ex;"><br><img class="stars feedback" id="star1" src="star1.png"><img class="stars feedback" id="star2" src="star2.png"><img class="stars feedback" id="star3" src="star3.png"><ul id="levelFeedbackText" style="resize: none; border: 0; text-align: center; overflow: hidden; font-size: 16pt; font-family: Arial;"><li id="nextLevelMsg" style="display: none">Congratulations! You have completed this level.</li><li id="finalLevelMsg" style="display: none">Congratulations! You have solved the final level.</li><li id="emptyBlocksError" class="feedback" style="display: none">Remove unused empty blocks.</li><li id="ifError" class="feedback" style="display: none">Try using the if block.</li><li id="whileError" class="feedback" style="display: none">Try using the repeat block.</li><li id="tooManyBlocksError" class=feedback" style="display: none">This level can be solved with fewer blocks</li></ul><div id="interstitial" style="display: none;">' + ((opt_ijData.level == 2) ? '<img style="margin-left: 110px;" src="repeat_block.png">' : '') + '<br><div id="reinfbubble"><span id="reinfMsg">';
