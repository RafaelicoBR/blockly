...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  for (var i172 = 1; i172 < 11; i172++) {
    output += ' ' + ((i172 == opt_ijData.level) ? (i172 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i172) + '</span>' : '<span class="selected tab">' + soy.$$escapeHtml(i172) + '</span>' : (i172 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i172) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i172) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i172) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i172) + '</a>');
  }
