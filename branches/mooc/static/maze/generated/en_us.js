...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      ...
      break;
    case 3:
      output += '<li id="moveForwardError1" class="feedback" style="display: none">The \'move forward\' block moves one block forward.</li><li id="moveForwardError2" class="feedback" style="display: none">Drag a \'move forward\' block from the toolbox to the workspace.</li><li id="mazeForeverError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="mazeForeverError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around the \'move forward\' block.</li>';
      break;
    case 4:
      output += '<li id="moveForwardError1" class="feedback" style="display: none">The \'move forward\' block moves one block forward.</li><li id="moveForwardError2" class="feedback" style="display: none">Drag and snap a \'move forward\' block below a \'turn\' block so I can move in the new direction.</li><li id="turnError1" class="feedback" style="display: none">Use both a \'turn left\' and a \'turn right\' block on this level.</li><li id="turnError2" class="feedback" style="display: none">Drag and snap a \'turn\' block under a \'move forward\' block when I need to change directions.</li><li id="mazeForeverError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="mazeForeverError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around the other blocks.</li>';
      break;
    case 5:
    case 6:
      output += '<li id="moveForwardError1" class="feedback" style="display: none">The \'move forward\' block moves one block forward.</li><li id="moveForwardError2" class="feedback" style="display: none">Drag and snap a \'move forward\' block below a \'turn\' block so I can move in the new direction.</li><li id="turnLeftError1" class="feedback" style="display: none">Use the \'turn left\' block when I need to turn to the left.</li><li id="turnLeftError2" class="feedback" style="display: none">Drag and snap the \'turn left\' block inside an \'if\' block.</li><li id="mazeForeverError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="mazeForeverError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around the other blocks.</li><li id="isPathLeftError1" class="feedback" style="display: none">Use the if block to turn left if there is a path to the left.</li><li id="isPathLeftError2" class="feedback" style="display: none">Place a turn left block inside the \'if\' block to turn left if there is a path to the left.</li>';
      break;
    case 7:
      output += '<li id="moveForwardError1" class="feedback" style="display: none">The \'move forward\' block moves one block forward.</li><li id="moveForwardError2" class="feedback" style="display: none">Drag and snap a \'move forward\' block below a turn block so I can move in the new direction.</li><li id="turnRightError1" class="feedback" style="display: none">Use the \'turn right\' block when I need to turn to the right.</li><li id="turnRightError2" class="feedback" style="display: none">Drag and snap the \'turn right\' block inside an \'if\' block.</li><li id="mazeForeverError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="mazeForeverError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around the other blocks.</li>';
      break;
    case 8:
      ...
      break;
    case 9:
      output += '<li id="turnLeftError1" class="feedback" style="display: none">Use the \'turn left\' block when I need to turn to the left.</li><li id="turnLeftError2" class="feedback" style="display: none">Drag and snap the \'turn left\' block inside the \'if-else\' block.</li><li id="ifElseError1" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the if statement is not true."</li><li id="ifElseError2" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the if statement is not true."</li><li id="isPathForwardError1" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="isPathForwardError2" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="mazeForeverError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="mazeForeverError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around all of your blocks.</li>';
      break;
    case 10:
      output += '<li id="isPathForwardError1" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="isPathForwardError2" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="ifElseError1" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the if statement is not true."</li><li id="ifElseError2" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the \'if\' statement is not true.</li><li id="mazeForeverError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="mazeForeverError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around all of your blocks.</li>';
      break;
  }
