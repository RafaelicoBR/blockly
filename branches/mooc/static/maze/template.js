...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<table width="100%" height="100%"><tr><td width="410" valign="top"><h1><a href="../">MOOC</a> &gt; ' + soy.$$escapeHtml(opt_ijData.MSG.title) + '</h1><div>' + soy.$$escapeHtml(opt_ijData.MSG.level) + ': &nbsp;';
